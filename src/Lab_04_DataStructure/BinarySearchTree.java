...
/**
 * An AVL tree is actually an extension of a Binary Search Lab_04_DataStructure.Tree
...
public class BinarySearchTree<T extends Comparable<T>> extends Tree<T> {
     ...
     * to the parent class inheriting Lab_04_DataStructure.Tree. In this case a Lab_04_DataStructure.BinarySearchTree.
     */
