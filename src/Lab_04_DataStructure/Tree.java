...
/**
 * The following interface defines required methods of any Lab_04_DataStructure.Tree.
 * Note that this is simplified for this lab (no delete).
 *
 * @param <T> the generic type this Lab_04_DataStructure.Tree uses. It extends comparable
...
public abstract class Tree<T extends Comparable<T>> {
    ...
    public int getHeight() {
        // Check whether leftNode or rightNode are Lab_04_DataStructure.EmptyTree
