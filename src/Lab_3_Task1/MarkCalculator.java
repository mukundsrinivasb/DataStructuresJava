 ...
 *
 * If all assessments items aside from the final exam are made redeemable (allRedeemableOnFinal
 *  will be true) then a student will receive whichever is greater:
 *  their final grade accounting for all course assessments or their final exam mark.
 * 
...
public interface MarkCalculator {
    MarkGrade calculateMark(int lab, int assignment1, int assignment2, int finalExam, boolean attendedFinal, boolean allRedeemableOnFinal) throws ComponentOutOfRangeException;
}
